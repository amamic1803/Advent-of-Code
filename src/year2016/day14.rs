...
impl Day14 {
    ...
    fn calculate_passwords<T: Fn(&str, &mut String)>(input: &str, hash_fn: T) -> u64 {
            ...
            for (j, re) in RE_5.iter().enumerate() {
                if re.find(&hash_out).is_some() {
                    ...
                    while let Some(last_ind) = last_occurences_3[j].get(processed_items).copied() {
                        ...
                        if passwords_found.len() == Self::PASSWORDS_TO_FIND as usize {
        ...
        passwords_found.truncate(Self::PASSWORDS_TO_FIND as usize);
        passwords_found[Self::PASSWORDS_TO_FIND as usize - 1]
    }
}
impl Day for Day14 {
    fn id(&self) -> usize {
    ...
    fn part1(&self, input: &str) -> Result<String, Error> {
        Ok(Self::calculate_passwords(input, |hash_in, hash_out| {
    ...
    fn part2(&self, input: &str) -> Result<String, Error> {
        Ok(Self::calculate_passwords(input, |hash_in, hash_out| {
            ...
            for _ in 0..Self::ADDITIONAL_HASHES {
